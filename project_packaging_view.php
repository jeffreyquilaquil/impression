...
$page_title = 'Projects Packaging &amp; Labeling Details';
    ...
    <div class="panel-heading clearfix">
        <div class="clearfix">
            ...
            <div class="pull-right">
                ...
                ?>
                <a class="btn btn-primary btn-sm" href="project_packaging_designs.php?id=<?php echo $id; ?>&amp;pid=<?php echo $pid; ?>" title="View Designs"><span class="fa fa-file-image-o"></span> View Designs</a>
                <?php
                }
                ?>
