...
if (!can_access('Course Categories', 'view')){
    redirect(WEBSITE_URL.'index.php');
}

$q_key = 'q_lu_course_categories';
$qg_key = 'qg_lu_course_categories';
...
$sql = "SELECT * FROM psi_course_categories";
$where = '';

if (strlen($q) > 0){
    $where .= "(course_cat_name like '%$q%')";
}
...
$sql .= ' ORDER BY course_cat_name ASC';
...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            ?>
            <a class="btn btn-primary btn-sm" href="lu_course_categories_form.php?op=0&amp;id=0" title="Add Category"><span class="fa fa-plus"></span> Add Category</a>
            <?php
            }
            ?>
        </div>
    ...
    <div class="panel-body">
        <form method="POST" action="lu_course_categories.php" accept-charset="UTF-8" class="form-inline" role="form">
        	...
        	if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Course Categories', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'lu_course_categories_form.php?op=1&amp;id='.$row['course_cat_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }
                    if (can_access('Course Categories', 'delete')){
                        $action .= '<a class="btn btn-primary btn-xs" href="javascript:void(0);" onclick="confirmDialog(\'Delete this record?\', \'Confirm Delete\', \''.WEBSITE_URL.'lu_course_categories_delete.php?op=2&amp;id='.$row['course_cat_id'].'\');" title="Delete"><span class="fa fa-close"></span></a>  ';
                    }
?>                <tr>
