...
page_header('Users ('.$opstr.')');

?>
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <h3 class="panel-title pull-left">Users (<?php echo $opstr; ?>) </h3>
    ...
    <div class="panel-body">
        ...
        <?php } ?>
        <form method="POST" action="users_save_admin.php?op=<?php echo $op; ?>&amp;id=<?php echo $id; ?>" accept-charset="UTF-8" class="form" role="form">
