...
if (!can_access('Media Activity Categories', 'view')){
    redirect(WEBSITE_URL.'index.php');
}

$q_key = 'q_lu_activity_types';
$qg_key = 'qg_lu_activity_types';
...
$sql = "SELECT * FROM psi_activity_types";
$where = '';
...
$sql .= ' ORDER BY activity_type_name ASC';

$rows = mysqli_query($GLOBALS['cn'], $sql);

$page_title = 'Media Activity Categories';
...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            ?>
                <a class="btn btn-primary btn-sm" href="lu_activity_categories_form.php?op=0&amp;id=0" title="Add Category"><span class="fa fa-plus"></span> Add Category</a>
            <?php
            }
            ?>
        </div>
    ...
    <div class="panel-body">
        <form method="POST" action="lu_activity_types.php" accept-charset="UTF-8" class="form-inline" role="form">
        	...
        	if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Media Activity Categories', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'lu_activity_categories_form.php?op=1&amp;id='.$row['activity_type_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }
                    if (can_access('Media Activity Categories', 'delete')){
                        $action .= '<a class="btn btn-primary btn-xs" href="javascript:void(0);" onclick="confirmDialog(\'Delete this record?\', \'Confirm Delete\', \''.WEBSITE_URL.'lu_activity_categories_delete.php?op=2&amp;id='.$row['activity_type_id'].'\');" title="Delete"><span class="fa fa-close"></span></a>  ';
                    }
...
?>                <tr>
                    ...
                    <td class="nowrap" width="100%"><?php echo $row['activity_type_name']; ?></td>
                  </tr><?php
        		}
