...
if ($op == 1){
    ...
    $GLOBALS['pay_amount_due'] = ($rep['rep_monthly_payment'] > $rep['rep_total_balance']) ?  $rep['rep_total_balance'] : $rep['rep_monthly_payment'];
    if ($GLOBALS['pay_amount_due'] == 0){
        $GLOBALS['pay_amount_due'] = $rep['rep_monthly_payment'];
    }
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php } ?>
        <form method="POST" action="project_payments_save.php?op=<?php echo $op; ?>&amp;pid=<?php echo $pid; ?>&amp;id=<?php echo $id; ?>&amp;yr=<?php echo $yr; ?>&amp;mo=<?php echo $mo; ?>" accept-charset="UTF-8" class="form" role="form">
        ...
        <div class="form-group">
        <label for="pay_amount_due" class="control-label">Amount Due *</label>
        <input class="form-control input-sm" placeholder="Amount Due" min="0" step="any" required="required" name="pay_amount_due" id="pay_amount_due" type="number" value="<?php echo $GLOBALS['pay_amount_due']; ?>">
                </div>

        <div class="form-group">
        <label for="pay_count" class="control-label">No. of Months Paid For *</label>
        <input class="form-control input-sm" placeholder="No. of Months Paid For" min="1" max="<?php echo $max_defs; ?>" step="1" required="required" name="pay_count" id="pay_count" type="number" value="<?php echo $GLOBALS['pay_count']; ?>">
                </div>

        <div class="form-group">
        <label for="pay_amount_paid" class="control-label">Amount Paid *</label>
        <input class="form-control input-sm" placeholder="Amount Paid" min="0" step="any" required="required" name="pay_amount_paid" id="pay_amount_paid" type="number" value="<?php echo $GLOBALS['pay_amount_paid']; ?>">
                </div>
        ...
        <div class="form-group">
        <label for="pay_overdue_amount_due" class="control-label">Overdue Amount</label>
        <input class="form-control input-sm" placeholder="Overdue Amount" min="0" step="any" name="pay_overdue_amount_due" id="pay_overdue_amount_due" type="number" value="<?php echo $GLOBALS['pay_overdue_amount_due']; ?>">
                </div>

        <!--

        <div class="form-group">
        <label for="pay_overdue_amount_paid" class="control-label">Overdue Amount Paid </label>
        <input class="form-control input-sm" placeholder="Overdue Amount Paid" min="0" step="any" name="pay_overdue_amount_paid" id="pay_overdue_amount_paid" type="number" value="<?php echo $GLOBALS['pay_overdue_amount_paid']; ?>">
                </div>

        <div class="form-group">
        <label for="pay_overdue_date_paid" class="control-label">Overdue Date Paid </label>
        &nbsp;&nbsp;<span class="text-danger"><small></small></span>
        <input class="form-control input-sm date-picker" placeholder="Overdue Date Paid" maxlength="10" name="pay_overdue_date_paid" id="pay_overdue_date_paid" type="text" value="<?php echo $GLOBALS['pay_overdue_date_paid']; ?>">
                </div>

        -->

        <div class="form-group">
        <label for="pay_penalty_amount_due" class="control-label">Penalty Amount Due</label>
        <input class="form-control input-sm" placeholder="Penalty Amount Due" min="0" step="any" name="pay_penalty_amount_due" id="pay_penalty_amount_due" type="number" value="<?php echo $GLOBALS['pay_penalty_amount_due']; ?>">
                </div>

        <div class="form-group">
        <label for="pay_penalty_amount_paid" class="control-label">Penalty Amount Paid </label>
        <input class="form-control input-sm" placeholder="Penalty Amount Paid" min="0" step="any" name="pay_penalty_amount_paid" id="pay_penalty_amount_paid" type="number" value="<?php echo $GLOBALS['pay_penalty_amount_paid']; ?>">
                </div>

        <div class="form-group">
        <label for="pay_penalty_date_paid" class="control-label">Penalty Date Paid </label>
        &nbsp;&nbsp;<span class="text-danger"><small></small></span>
        <input class="form-control input-sm date-picker" placeholder="Penalty Date Paid" maxlength="10" name="pay_penalty_date_paid" id="pay_penalty_date_paid" type="text" value="<?php echo $GLOBALS['pay_penalty_date_paid']; ?>">
                </div>
        ...
        <input type="hidden" name="pay_otb" value="0">
