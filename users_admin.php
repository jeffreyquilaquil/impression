...
if (strlen($q) > 0){
    $where .= "((u_fname like '%$q%') OR (u_mname like '%$q%') OR (u_lname like '%$q%'))";
}
...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            ?>
            <a class="btn btn-primary btn-sm" href="users_form_admin.php?op=0&amp;id=0" title="Add User"><span class="fa fa-plus"></span> Add User</a>
            <?php
            }
            ?>
        </div>
        	...
        	if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Users', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'users_form_admin.php?op=1&amp;id='.$row['u_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }
