...
$page_title = 'Project Fora/Trainings/Seminars ('.$opstr.')';
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php } ?>
        <form method="POST" action="project_trainings_save.php?op=<?php echo $op; ?>&amp;id=<?php echo $id; ?>&amp;pid=<?php echo $pid; ?>" accept-charset="UTF-8" class="form" role="form">
...
<!--
        ...
        <div class="form-group">
            ...
            <input class="form-control input-sm" placeholder="No. of Masculine Participants" min="0" step="1" required="required" name="fr_no_masculine" id="fr_no_masculine" type="number" value="<?php echo $GLOBALS['fr_no_masculine']; ?>">
