...
if (!can_access('Equipment Names', 'view')){
...
$sql = "SELECT * FROM psi_equipment_brands";
$where = '';
...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            ?>
            <a class="btn btn-primary btn-sm" href="lu_brands_form.php?op=0&amp;id=0" title="Add Name"><span class="fa fa-plus"></span> Add Name</a>
            <?php
            }
            ?>
        </div>
    ...
    <div class="panel-body">
        <form method="POST" action="lu_brands.php" accept-charset="UTF-8" class="form-inline" role="form">
        	...
        	if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Equipment Names', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'lu_brands_form.php?op=1&amp;id='.$row['brand_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }
                    if (can_access('Equipment Names', 'delete')){
                        $action .= '<a class="btn btn-primary btn-xs" href="javascript:void(0);" onclick="confirmDialog(\'Delete this record?\', \'Confirm Delete\', \''.WEBSITE_URL.'lu_brands_delete.php?op=2&amp;id='.$row['brand_id'].'\');" title="Delete"><span class="fa fa-close"></span></a>  ';
                    }
