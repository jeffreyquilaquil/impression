...
if (!dbValueExists('psi_fora', 'fr_id', $did, false)){
    redirect(WEBSITE_URL.'prject_trainings.php?pid='.$pid);
    die();
}
...
$page_title = 'Project Fora/Trainings/Seminars Documents';
    ...
    <div class="panel-heading clearfix">
        <div class="clearfix">
            ...
            <div class="pull-right">
                ...
                ?>
                <a class="btn btn-primary btn-sm" href="project_trainings_documents_form.php?op=0&amp;id=0&amp;did=<?php echo $did; ?>&amp;pid=<?php echo $pid; ?>" title="Add Document"><span class="fa fa-plus"></span> Add Document</a>
                <?php
                }

                if (can_access('Project Fora', 'view')){
                ?>
                <a class="btn btn-primary btn-sm" href="project_trainings_view.php?pid=<?php echo $pid; ?>&amp;did=<?php echo $did; ?>" title="Project Details"><span class="fa fa-folder-open"></span> Details</a>
                <?php
                }

                ?>
                <a class="btn btn-primary btn-sm" href="project_trainings.php?pid=<?php echo $pid; ?>" title="Project Fora/Trainings/Seminars"><span class="fa fa-arrow-circle-left"></span> Back</a>
            </div>
        </div>
        <div class="pull-left">
            <small>
            ...
            if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Project Fora Documents', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'project_trainings_documents_form.php?op=1&amp;pid='.$pid.'&amp;did='.$did.'&amp;id='.$row['frdoc_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }

                    if (can_access('Project Fora Documents', 'delete')){
                        $action .= '<a class="btn btn-primary btn-xs" href="javascript:void(0);" onclick="confirmDialog(\'Delete this record?\', \'Confirm Delete\', \''.WEBSITE_URL.'project_trainings_documents_delete.php?op=2&amp;did='.$did.'&amp;pid='.$pid.'&amp;id='.$row['frdoc_id'].'\');" title="Delete"><span class="fa fa-close"></span></a>';
                    }
