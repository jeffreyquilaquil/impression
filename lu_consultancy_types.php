...
if (!can_access('Consultancy Categories', 'view')){
    redirect(WEBSITE_URL.'index.php');
}

$q_key = 'q_lu_consultancy_types';
$qg_key = 'qg_lu_consultancy_types';
...
$sql .= ' ORDER BY con_type_name ASC';

$rows = mysqli_query($GLOBALS['cn'], $sql);

$page_title = 'Consultancy Categories';
...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            ?>
            <a class="btn btn-primary btn-sm" href="lu_consultancy_types_form.php?op=0&amp;id=0" title="Add Category"><span class="fa fa-plus"></span> Add Category</a>
            <?php
            }
            ?>
        </div>
    ...
    <div class="panel-body">
        <form method="POST" action="lu_consultancy_types.php" accept-charset="UTF-8" class="form-inline" role="form">
        	...
        	if ($rows) {
                while($row = mysqli_fetch_array($rows)) {
                    ...
                    if (can_access('Consultancy Categories', 'edit')){
                        $action .= '<a class="btn btn-primary btn-xs" href="'.WEBSITE_URL.'lu_consultancy_types_form.php?op=1&amp;id='.$row['con_type_id'].'" title="Edit"><span class="fa fa-pencil"></span></a>  ';
                    }

                    if (can_access('Consultancy Categories', 'delete')){
                        $action .= '<a class="btn btn-primary btn-xs" href="javascript:void(0);" onclick="confirmDialog(\'Delete this record?\', \'Confirm Delete\', \''.WEBSITE_URL.'lu_consultancy_types_delete.php?op=2&amp;id='.$row['con_type_id'].'\');" title="Delete"><span class="fa fa-close"></span></a>  ';
                    }
